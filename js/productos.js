// ==========================================
// js/productos.js - Filtros y Lógica de Catálogo
// ==========================================
...
/**
 * Inicializa el slider de rango de precios (noUiSlider)
 * Requiere: https://cdnjs.cloudflare.com/ajax/libs/noUiSlider/15.5.0/nouislider.min.js
 */
...
/**
 * Filtra productos por las formas seleccionadas (solo para Base para Tortas)
...
/**
 * Muestra u oculta el filtro de formas según la categoría activa
 */
 ...
 * @param {Array} [productosBase] - Array base de productos (por defecto productosGlobales)
 * @returns {Array}
 */
...
/**
 * Muestra los productos filtrados en el contenedor principal
 */
...
/**
 * Configura los event listeners para la página de catálogo
 */
function configurarPaginaCatalogo() {
  ...
  // Listeners para items de categoría en sidebar
  ...
  // Redimensionar para filtro móvil
  window.addEventListener('resize', controlarFiltroForma);
}

/**
 * Carga las categorías en el sidebar de filtros
 */
...
/**
 * Carga la página de resultados de búsqueda
 */
async function cargarPaginaResultados() {
  ...
  if (mostrarDestacados) {
    ...
    document.getElementById('titulo-busqueda').textContent = 'Feliz Navidad';
  } else if (termino) {
